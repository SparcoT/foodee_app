...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GroupListView(physics: BouncingScrollPhysics(),
        ...
        itemBuilder: (BuildContext context, IndexPath index) {
          return ListTile(
            contentPadding: EdgeInsets.symmetric(vertical: 2.5,horizontal: 10.0),
            dense: true,
            leading: CircleAvatar(backgroundColor: AppTheme.primaryColor,
